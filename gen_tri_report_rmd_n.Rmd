...
**Assumptions:** The key sources of bias (specific confounders, misclassification bias and other biases) are the same (shared) for the maternal and partner exposures; there is no real causal effect of the partner's exposure on the outcome *operating via the same mechanism as the maternal effect*. The maternal and partner exposures are measured on the same/similar scales.
