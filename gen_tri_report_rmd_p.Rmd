...
**Possible insights from the plot below:** If there is an intrauterine effect, or a sensitive/critical period, we would expect to see stronger effects (i.e. estimates further from the null) in those periods, compared to others. These observations should remain after adjustment for the exposure in a previous period.